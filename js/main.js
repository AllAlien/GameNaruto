$(document).ready(function() {
    ...
    $("img").click(function() {
        ...
        //gambiarra pra pegar o nome do lutador 2 ... sorry,
        var lut2 = lutador2[l2];
        var lut3 = lut2.replace("img/", "");
        var nome2 = lut3.replace(".png", "");
        ...
        $(".escolha").show()
            // Instancia de classe dos lutadores 1
        if (nome == "naruto") {
        ...
        // instancia de classe dos lutadores 2
        if (nome2 == "naruto") {
            var naruto = new Lutadores("Naruto", 79, 89, 1.80, "Usumaki", 95);
            var n = naruto.nome;
            var forca = naruto.forca;
            ...
            $(".descricao_lutador2").html("<p>Nome: " + n + "<br>" +
                "Força: " + forca + "<br>" +
                "Velocidade: " + vel + "<br>" +
                "Altura: " + alt + "<br>" +
                "Cla: " + cla + "<br>" +
